package igentuman.evtweaks.gui;
...
public class GuiMechanicalForgeHammer extends BaseGui {
    ...
    public GuiMechanicalForgeHammer(ContainerMechanicalForgehammer inventorySlotsIn) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRenderer.drawString(I18n.format("container.mechanical_forgehammer"), 28, 6, 4210752);
