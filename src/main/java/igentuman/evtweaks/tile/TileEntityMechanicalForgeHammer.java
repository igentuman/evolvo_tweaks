package igentuman.evtweaks.tile;

import igentuman.evtweaks.ModConfig;
import igentuman.evtweaks.RegistryHandler;
import igentuman.evtweaks.block.BlockMechanicalForgeHammer;
import igentuman.evtweaks.capability.InputMechCapability;
...
public class TileEntityMechanicalForgeHammer extends TileEntity implements ITickable {
    ...
    public TileEntityMechanicalForgeHammer() {
        super();
    ...
    public EnumFacing findDirection() {
        ...
        return bs.getBlock() == RegistryHandler.MECHANICAL_FORGEHAMMER ?
                bs.getValue(BlockMechanicalForgeHammer.FACING) : EnumFacing.DOWN;
    }
